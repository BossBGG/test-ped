...
const ElectricalRepairOrderS308 = () => {
  ...
  useEffect(() => {
    setBreadcrumb(
      <WorkOrderBreadcrumb
        title={"สร้างใบสั่งงาน ขอตรวจสอบระบบไฟฟ้าพร้อมออกใบรับรอง"}
        path={"s308"}
      />
    );
  }, [setBreadcrumb]);
  ...
  const updateTransformer = (value: Transformer[]) => {
...
export default ElectricalRepairOrderS308;
